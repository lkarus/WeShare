...
function PasswordWidget(divid,pwdname, placeholder)
{
...
function _MakePWDWidget()
{
	...
	code += "<input type='password' class='pwdfield form-control' name='"+pwdname+"' placeholder='"+this.placeholder+"' id='"+this.pwdfieldid+"'>";
