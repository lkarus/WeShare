...
if(isset($_POST['seleted_dir_to_move'])){
    //echo "<script type='text/javascript'>alert('Move to: ".$_POST['seleted_dir_to_move']."');</script>";

    $move_to = $_POST['seleted_dir_to_move'];
    if(isset($_POST['file_name'])){
        $file_name = $_POST['file_name'];
        //echo "<script type='text/javascript'>alert('".$_POST['file_name']."');</script>";
        if(isset($_POST['path'])){
            $path_from = $_POST['path'];
            $path_from = $path_from."/".$file_name;
            $path_to = $_POST['path']."/".$move_to."/".$file_name;
...
<head>
    ...
    <!--Uploadify library linking-->
    <script src="../external/jquery.uploadifive.min.js" type="text/javascript"></script>
        ...
        <div class = "row">
            ...
            <div class="col-sm-8">
                                    ...
                                    <script type="text/javascript">
                                        <?php $timestamp = time();
                                            if(isset($_GET['dir_open'])){
                                                echo "var current_dir = '".$_GET['dir_open']."'";
                                            }else{
                                        ...
                                        $(function () {
                                            $('#file_upload').uploadifive({
                                                ...
                                                'onUpload': function(filesToUpload) {
                                                    ...
                                                    document.getElementById("queue").style.display = "visible";
                                                },
                                                'onUploadComplete': function (file, data) {
                                                    document.getElementById("queue").style.display = "hidden";
                                                }
                                            });
                                        });
                                </script>
			  ...
			  },
              {
                name: "New Folder",
                onClick: function(row){
                    $.fancybox.open({href: "../login_user/new_dir.php?open_dir='.$current_dir.'&path='.$path.'", type: "iframe", autoResize: true});}
              }, 
				{
				    name: "Download",
				    onClick: function(row) {
				    	var current = "'.$current_dir.'";
				    	if(current == ""){
				    		var path_to_download = "'.$path.'/'.'"+row.name;
				    	}
				    	else{
				    		var path_to_download = "'.$path.'/'.$current_dir.'/'.'"+row.name;
				    	}
				    	window.open("download.php?download_file="+path_to_download);
				    }
							},
								   {
								    name: "Delete",
			...
			$.fancybox.open({href: "../login_user/delete_confirmation.php?file_name="+file, type: "iframe", autoResize: true});
                        ...
                        <div id='use-without-login'>
                            ...
                            <form action="../youtube_video/index.html" method="get">
                                <div class="input-group">
                                    <input name="yt" type="text" placeholder='Paste Youtube video link HERE.' class="form-control">
                        ...
                        <script type="text/javascript">
                            ...
                            $(function() {
                                $('#file_upload').uploadifive({
                                    ...
                                    'queueID'          : 'queue',
                                    'uploadScript'     : '../external/uploadifive.php',
                                    'onUploadComplete' : function(file, data) { location.reload(); }
                                });
                            });
                        </script>
                    ...
                    <div class="tab-pane" id="change_profile" style="display:none">
                        <form id='changename' action='<?php echo $fgmembersite->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
                            <fieldset >
                                ...
                                <div class="form-group">
                                    <input type='text' class="form-control" name='name' id='name' placeholder='Your Full Name' value="<?php echo $fgmembersite->UserFullName() ?>"/>
                                    <span id='register_name_errorloc' class='error'></span>
                                </div>
                                <div class="form-group">
                                    <input type='submit' name='Submit' value='Confirm' class="btn btn-primary col-md-offset-3"/>
                                </div>
                        ...
                        <form id='changepwd' action='<?php echo $fgmembersite->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
                            <fieldset >
                                ...
                                <div class='form-group'>
                                    ...
                                    <noscript>
                                        <input type='password' placeholder="Current password" class="form-control" name='oldpwd' id='oldpwd' maxlength="50" />
                                    </noscript>
                                ...
                                <div class='form-group'>
                                    ...
                                    <noscript>
                                        <input type='password' placeholder="New password" class="form-control" name='newpwd' id='newpwd' maxlength="50" /><br/>
                                    </noscript>
                    ...
                    <div class="tab-pane" id="friendlist" style="display:none">
                        <form id='addfriend' action='<?php echo $fgmembersite->GetSelfScript()."#friendlist"; ?>' method='post' accept-charset='UTF-8'>
                            <div class="form-group">
                                <form id="friendListSubmit" action='<?php echo $fgmembersite->GetSelfScript()."#friendlist"; ?>' method='post' accept-charset = 'UTF-8'>
                                    <input type='text' class="form-control" name='friendEmail' id='friendEmail' placeholder="Your friend's email" display="inline-block" width="80%"/>
                                    <input type='submit' name='Submit' value='Add' class="btn btn-primary col-md-offset-3"/>
                                </form>
                            </div>
